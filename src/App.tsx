        ...
        >
          <div className="w-28 h-28 md:w-48 md:h-48 mx-auto bg-gradient-to-r from-indigo-800 to-blue-700 rounded-full flex items-center justify-center mb-4 md:mb-6 relative shadow-2xl border-2 md:border-4 border-cyan-400/30">
            ...
            <motion.div
              ...
              className="absolute -top-2 md:-top-4 -right-2 md:-right-4 w-8 h-8 md:w-14 md:h-14 bg-gradient-to-r from-cyan-400 to-teal-300 rounded-full flex items-center justify-center"
            >
            ...
            <motion.div
              ...
              className="absolute -bottom-1.5 md:-bottom-3 -left-1.5 md:-left-3 w-7 h-7 md:w-12 md:h-12 bg-gradient-to-r from-teal-400 to-cyan-300 rounded-full flex items-center justify-center"
            >
            ...
            <motion.div
              ...
              className="absolute -top-0.5 md:-top-2 -left-3 md:-left-6 w-5 h-5 md:w-9 md:h-9 bg-gradient-to-r from-cyan-300 to-teal-400 rounded-full flex items-center justify-center"
            >
          ...
          >
            <div className="w-14 h-14 md:w-24 md:h-24 bg-gradient-to-r from-teal-500/30 to-cyan-400/30 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-5 relative border border-cyan-400/50">
              ...
              <motion.div
                ...
                transition={{ duration: 2, repeat: Infinity }}
                className="absolute -top-0.5 md:-top-1 -right-0.5 md:-right-1 w-3 h-3 md:w-5 md:h-5 bg-gradient-to-r from-cyan-400 to-teal-500 rounded-full flex items-center justify-center"
              >
